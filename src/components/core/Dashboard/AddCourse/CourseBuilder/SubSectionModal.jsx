				...
				>
					...
					<div className="flex flex-col space-y-2">
						...
						<textarea
							...
							className="form-style resize-x-none min-h-[130px] form-style w-full rounded-[0.5rem] bg-richblack-700 p-[10px] text-richblack-5 border-b-[1px] border-richblack-100"
						/>
						{errors.lectureDesc && (
							<span className="ml-2 text-xs tracking-wide text-pink-200">
